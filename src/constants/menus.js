export const menus = [
    ...
    { key: '/app/organization/index', title: '机构管理', icon: 'usb' },
    { key: '/app/staff/index', title: '员工管理', icon: 'team' },
    { key: '/app/foreign/index', title: '外教介绍', icon: 'user' },
    { key: '/app/recharge/index', title: '充值记录', icon: 'pay-circle-o' },
    { key: '/app/historyclass/index', title: '课消记录', icon: 'shop' },
    
    {
        key: '/app/dashboard/index', title: 'UI首页', icon: 'home',
        sub: [
            {
...
export const subMenus = {
    ...
    organization: [
        { key: '/app/organization/index', title: '机构管理' },
        { key: '' },
    ],
}